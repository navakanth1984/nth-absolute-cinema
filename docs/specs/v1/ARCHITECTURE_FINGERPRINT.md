# NAC Architecture Fingerprint — v1.2

**Freeze date:** 2026-07-03 (v1.0); **updated:** 2026-07-04 (v1.1 then v1.2,
both additive)
...
**2026-07-04 changes:** (1) added `CHARACTER_GENOME_SPEC.md` (new file, v1.1
draft) and regenerated `CREATIVE_GRAPH_SPEC.md`'s hash after a MINOR
(additive) expansion of the `CharacterGenome`/`DialogueGenome` field groups in
its §4; (2) same day, tightened before merge to v1.2: added the universal
Genome Composition Rule (§4.1), genome ownership table (§4.2),
`GenomeReference` replacing bare `*_genome_ref: UUID` fields (§4.3), genome
reusability across projects (§4.4), and `GenomeProductionRecord` in
`ProductionGraph` (§6) replacing the Production field group originally
drafted inline on `CharacterGenome`. No field was removed or renamed at any
step — see `CHARACTER_GENOME_SPEC.md` §8-9 for the exact migration mappings.
...
|---|---|
| MANIFESTO.md | v1.0 |
| CREATIVE_GRAPH_SPEC.md | v1.2 |
| CHARACTER_GENOME_SPEC.md | v1.2 |
...
```
15d274631a258197cd78a0dd6f541dfac4a3b9ed83d887560ed4f893cfa6a14d  CHARACTER_GENOME_SPEC.md
...
262ea1d1a939e525f50013274f408a9ff6b86c8e9c2189e511ee09704b877baa  CREATIVE_GRAPH_SPEC.md
...
```
92dea271085a2dae97e218d3f4bb57cef01bb2a9ba1051ebdc4697dafa4d3843
```
